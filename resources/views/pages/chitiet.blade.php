    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-9">
                ...
                <!-- Preview Image -->
                <img width="200px" height="100px" class="img-responsive" src="/upload/tintuc/{{$tintuc->Hinh}}" alt="">
                ...
                @else
                    <h4>Vui lòng đăng nhập để viết bình luận<span class="glyphicon glyphicon-pencil"></span></h4>
                @endif
                <hr>
            ...
            <div class="col-md-3">
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="row" style="margin-top: 10px;">
                            <div class="col-md-5">
                                <a href="chitiet/{{$tlq->id}}/{{$tlq->TieuDeKhongDau}}.html">
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="row" style="margin-top: 10px;">
                            <div class="col-md-5">
                                <a href="chitiet/{{$tnb->id}}/{{$tnb->TieuDeKhongDau}}.html">
