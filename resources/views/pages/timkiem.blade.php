            ...
            <div class="col-md-9 ">
                <div class="panel panel-default">
                    <div class="panel-heading" style="background-color:#337AB7; color:white;">
                        <h4><b>Tìm kiếm theo từ khóa: {{$tukhoa}}</b></h4>
                    </div>
                    ...
                    <div class="row-item row">
                        ...
                        <div class="col-md-9">
                            ...
                            <a class="btn btn-primary" href="chitiet/{{$tt->id}}/{{$tt->TieuDeKhongDau}}.html">Chi tiết<span class="glyphicon glyphicon-chevron-right"></span></a>
                        </div>
                        <div class="break"></div>
                    </div>
                    @endforeach
